$(document).ready(function() {
    ...
    var paginacion = function(pagina) {
        ...
        $.post(_ruta_ + 'items/paginaciondinamicasubcategorias', pagina , function(data) {
...
function borrar_subcategoria(id){
        ...
        fancyConfirm("Est&aacute; seguro que desea eliminar el registro?",
                function() {
                    var respuesta = $.post(_ruta_ + 'items/eliminarsubcategoria/'+ id);
