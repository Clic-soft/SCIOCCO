$(document).ready(function() {
    ...
    var paginacion = function(pagina) {
        ...
        $.post(_ruta_ + 'novedades/paginacionDinamicanovedades', pagina , function(data) {
...
function borrar_foto(id){
        ...
        fancyConfirm("Est&aacute; seguro que desea eliminar la foto?",
                function() {
                    var respuesta = $.post(_ruta_ + 'novedades/eliminarFoto/'+ id);
                    respuesta.done(function(data) {
                        alert(data);
                        if ($.isEmptyObject(data)) {
                                 window.location.reload();
