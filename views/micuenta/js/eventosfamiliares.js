function borrar_eventofamilia(id){
        fancyConfirm("Est&aacute; seguro que desea eliminar el registro?",
                function() {
                    var respuesta = $.post(_ruta_ + 'micuenta/eliminarEventoFamilia/' + id);
...
$(document).ready(function() {
    ...
    var paginacion = function(pagina) {
        ...
        $.post(_ruta_ + 'micuenta/paginacionDinamicaEventosFamiliares', pagina , function(data) {
