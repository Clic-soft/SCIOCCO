$(document).ready(function() {
    ...
    var paginacion = function(pagina) {
        ...
        $.post(_ruta_ + 'configuracion/paginacionDinamicat_documentos', pagina , function(data) {
