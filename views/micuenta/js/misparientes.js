$(document).ready(function() {
    ...
    var paginacion = function(pagina) {
        ...
        $.post(_ruta_ + 'micuenta/paginacionDinamicaParientes', pagina , function(data) {
