function borrar_detalle_carrito(id){
        fancyConfirm("Est&aacute; seguro que desea eliminar el registro?",
                function() {
                    var respuesta = $.post(_ruta_ + 'micuenta/eliminarDetalleCarrito/' + id);
...
$(document).ready(function() {
    ...
    var paginacion = function(pagina) {
        ...
        $.post(_ruta_ + 'micuenta/paginacionDinamicaCarrito', pagina , function(data) {
