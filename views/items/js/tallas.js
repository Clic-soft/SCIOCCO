$(document).ready(function() {
    ...
    var paginacion = function(pagina) {
        ...
        $.post(_ruta_ + 'items/paginaciondinamicatallas', pagina , function(data) {
